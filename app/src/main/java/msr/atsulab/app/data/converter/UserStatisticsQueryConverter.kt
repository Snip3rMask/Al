...
import msr.atsulab.app.UserStatisticsQuery
import msr.atsulab.app.data.response.anilist.*
import msr.atsulab.app.fragment.UserStatistics
...
fun UserStatistics?.convert(): msr.atsulab.app.data.response.anilist.UserStatistics {
