...
import msr.atsulab.app.SocialDataQuery
import msr.atsulab.app.data.response.SocialData
import msr.atsulab.app.data.response.anilist.*
import msr.atsulab.app.fragment.ActivityUser
import msr.atsulab.app.fragment.ActivityReply
import msr.atsulab.app.fragment.OnListActivity
import msr.atsulab.app.fragment.OnMessageActivity
import msr.atsulab.app.fragment.OnTextActivity
...
fun ActivityReply.convert(): msr.atsulab.app.data.response.anilist.ActivityReply {
    return msr.atsulab.app.data.response.anilist.ActivityReply(
        id = id,
        userId = userId ?: 0,
