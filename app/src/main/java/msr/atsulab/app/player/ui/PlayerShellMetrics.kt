...
object PlayerShellMetrics {
    ...
    const val SKIP_MARKER_HEIGHT_DP = 4
    ...
    const val QUALITY_PANEL_WIDTH_DP = 380
    const val SERVER_PANEL_WIDTH_DP = 340
    const val EPISODE_PANEL_MIN_WIDTH_DP = 420
    const val EPISODE_PANEL_MAX_WIDTH_DP = 560
