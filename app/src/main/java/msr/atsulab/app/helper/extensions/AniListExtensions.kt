package msr.atsulab.app.helper.extensions
...
fun msr.atsulab.app.type.MediaType.getMediaType(): MediaType {
    return when (this) {
        msr.atsulab.app.type.MediaType.ANIME -> MediaType.ANIME
        msr.atsulab.app.type.MediaType.MANGA -> MediaType.MANGA
