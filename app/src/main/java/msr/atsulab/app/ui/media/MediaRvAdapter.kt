...
import msr.atsulab.app.databinding.*
...
import msr.atsulab.app.helper.utils.*
import msr.atsulab.app.ui.base.BaseRecyclerViewAdapter
import msr.atsulab.app.ui.common.GenreRvAdapter
        ...
        override fun bind(item: MediaItem, index: Int) {
            ...
            binding.listRecyclerView.adapter = GenreRvAdapter(context, item.media.genres, object : GenreRvAdapter.GenreListener {
                override fun getGenre(genre: Genre) {
                    listener.mediaGenreListener.navigateToExplore(item.media.type ?: msr.atsulab.app.type.MediaType.ANIME, genre)
                }
            })
        }
    }
    ...
    inner class InfoViewHolder(private val binding: LayoutMediaInfoBinding) : ViewHolder(binding) {
        override fun bind(item: MediaItem, index: Int) {
            binding.apply {
                ...
                mediaInfoSeasonLayout.show(item.media.type == msr.atsulab.app.type.MediaType.ANIME && item.media.season != null && item.media.seasonYear != null)
                ...
                mediaInfoSeasonText.clicks {
                    if (item.media.season != null && item.media.seasonYear != null) {
                        listener.mediaInfoListener.navigateToExplore(item.media.type ?: msr.atsulab.app.type.MediaType.ANIME, item.media.season, item.media.seasonYear)
                    }
                }
    ...
    inner class TagsViewHolder(private val binding: LayoutTitleAndListBinding) : ViewHolder(binding) {
        override fun bind(item: MediaItem, index: Int) {
            ...
            binding.listRecyclerView.adapter = MediaTagsRvAdapter(
                ...
                item.media.type ?: msr.atsulab.app.type.MediaType.ANIME,
