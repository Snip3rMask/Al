...
import msr.atsulab.app.databinding.DialogBottomSheetMediaListQuickDetailBinding
...
import msr.atsulab.app.ui.editor.AdvancedScoringRvAdapter
import msr.atsulab.app.ui.editor.CustomListsRvAdapter
        ...
        disposables.addAll(
            viewModel.settings.subscribe { (mediaListOptions, appSetting) ->
                ...
                with(binding) {
                    ...
                    dialogMediaListStatus.text = mediaList.status?.getString(media.type?.getMediaType() ?: msr.atsulab.app.helper.enums.MediaType.ANIME)
