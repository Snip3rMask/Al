...
import msr.atsulab.app.helper.pojo.MediaFilterComponent
    ...
    fun loadMediaFilterComponent() {
        _mediaFilterComponent.onNext(
            MediaFilterComponent(
                mediaFilter,
                when (currentSearchCategory) {
                    SearchCategory.ANIME -> msr.atsulab.app.helper.enums.MediaType.ANIME
                    SearchCategory.MANGA -> msr.atsulab.app.helper.enums.MediaType.MANGA
                    else -> msr.atsulab.app.helper.enums.MediaType.ANIME
                },
