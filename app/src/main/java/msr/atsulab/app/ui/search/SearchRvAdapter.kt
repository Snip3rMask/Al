...
import msr.atsulab.app.databinding.ListSearchBinding
            ...
            binding.apply {
                when (item.searchCategory) {
                    SearchCategory.ANIME, SearchCategory.MANGA -> {
                        ...
                        searchMediaListStatusText.text = item.media.mediaListEntry?.status?.getString(item.media.type?.getMediaType() ?: msr.atsulab.app.helper.enums.MediaType.ANIME)?.uppercase()
                        ...
                        searchMediaLengthText.text = when (item.media.type?.getMediaType()) {
                            msr.atsulab.app.helper.enums.MediaType.ANIME -> item.media.getLength()?.showUnit(context, R.plurals.episode)
                            msr.atsulab.app.helper.enums.MediaType.MANGA -> item.media.getLength()?.showUnit(context, R.plurals.chapter)
                            else -> ""
                        }
