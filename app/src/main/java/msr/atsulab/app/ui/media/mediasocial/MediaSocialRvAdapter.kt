package msr.atsulab.app.ui.media.mediasocial
...
import msr.atsulab.app.databinding.ListActivityMediaBinding
import msr.atsulab.app.databinding.ListFollowingMediaListBinding
...
import msr.atsulab.app.helper.pojo.MediaSocialItem
import msr.atsulab.app.helper.pojo.SocialItem
    ...
    inner class FollowingMediaListViewHolder(private val binding: ListFollowingMediaListBinding) : ViewHolder(binding) {
        override fun bind(item: MediaSocialItem?, index: Int) {
            ...
            with(binding) {
                ...
                val mediaType = if (item.mediaList.media.type == msr.atsulab.app.type.MediaType.MANGA) MediaType.MANGA else MediaType.ANIME
